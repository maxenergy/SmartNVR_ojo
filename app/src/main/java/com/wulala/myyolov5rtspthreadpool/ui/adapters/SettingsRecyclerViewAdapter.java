...
import com.wulala.myyolov5rtspthreadpool.databinding.FragmentSettingsItemBinding;
 ...
 * Adapted from ojo project for YOLOv5 RTSP settings
 */
public class SettingsRecyclerViewAdapter extends RecyclerView.Adapter<SettingsRecyclerViewAdapter.ViewHolder> implements ItemMoveCallback.ItemTouchHelperContract {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int position = holder.getBindingAdapterPosition();
                if (position != RecyclerView.NO_POSITION && position >= 0 && position < mValues.size()) {
